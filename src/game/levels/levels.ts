...
const round2: LevelDefinition[] = [
  ...
  },
  {
    ...
    spikes: [
      { id: 'stair-chase-1', x: 54, y: 358, w: 38, h: 32, hidden: true },
      { id: 'stair-chase-2', x: 154, y: 358, w: 38, h: 32, hidden: true },
      { id: 'stair-chase-3', x: 270, y: 358, w: 38, h: 32, hidden: true },
      { id: 'stair-chase-4', x: 388, y: 318, w: 38, h: 32, hidden: true },
      { id: 'stair-chase-5', x: 504, y: 282, w: 38, h: 32, hidden: true },
      { id: 'stair-chase-6', x: 624, y: 246, w: 38, h: 32, hidden: true },
      { id: 'stair-chase-7', x: 744, y: 210, w: 38, h: 32, hidden: true },
      { id: 'stair-chase-8', x: 856, y: 174, w: 38, h: 32, hidden: true },
    ],
