...
const round2: LevelDefinition[] = [
  ...
  },
  {
    ...
    spawn: { x: 62, y: 356 },
    platforms: [
      { id: 'start-floor', x: 0, y: FLOOR_Y, w: 372, h: FLOOR_H },
      { id: 'step-1', x: 404, y: 356, w: 92, h: 30 },
      { id: 'step-2', x: 520, y: 326, w: 92, h: 30 },
      { id: 'step-3', x: 636, y: 296, w: 92, h: 30 },
      { id: 'step-4', x: 752, y: 266, w: 92, h: 30 },
      { id: 'step-5', x: 850, y: 236, w: 110, h: 30 },
    ],
    spikes: [
      { id: 'stair-chase-1', x: 0, y: 358, w: 48, h: 32, hidden: true },
      { id: 'stair-chase-2', x: 48, y: 358, w: 48, h: 32, hidden: true },
      { id: 'stair-chase-3', x: 96, y: 358, w: 48, h: 32, hidden: true },
      { id: 'stair-chase-4', x: 144, y: 358, w: 48, h: 32, hidden: true },
      { id: 'stair-chase-5', x: 192, y: 358, w: 48, h: 32, hidden: true },
      { id: 'stair-chase-6', x: 240, y: 358, w: 48, h: 32, hidden: true },
      { id: 'stair-chase-7', x: 288, y: 358, w: 48, h: 32, hidden: true },
      { id: 'stair-chase-8', x: 336, y: 358, w: 36, h: 32, hidden: true },
      { id: 'stair-chase-9', x: 404, y: 324, w: 46, h: 32, hidden: true },
      { id: 'stair-chase-10', x: 450, y: 324, w: 46, h: 32, hidden: true },
      { id: 'stair-chase-11', x: 520, y: 294, w: 46, h: 32, hidden: true },
      { id: 'stair-chase-12', x: 566, y: 294, w: 46, h: 32, hidden: true },
      { id: 'stair-chase-13', x: 636, y: 264, w: 46, h: 32, hidden: true },
      { id: 'stair-chase-14', x: 682, y: 264, w: 46, h: 32, hidden: true },
      { id: 'stair-chase-15', x: 752, y: 234, w: 46, h: 32, hidden: true },
      { id: 'stair-chase-16', x: 798, y: 234, w: 46, h: 32, hidden: true },
      { id: 'stair-chase-17', x: 850, y: 204, w: 55, h: 32, hidden: true },
      { id: 'stair-chase-18', x: 905, y: 204, w: 55, h: 32, hidden: true },
    ],
    doors: [{ id: 'exit', kind: 'real', x: 884, y: 166, w: 38, h: 70, open: true }],
  ...
  },
  {
    ...
    platforms: [
      ...
      { id: 'hide-hole', x: 790, y: 440, w: 96, h: 100 },
      { id: 'floor-right', x: 886, y: FLOOR_Y, w: 74, h: FLOOR_H },
      { id: 'low-roof', x: 104, y: 332, w: 856, h: 18 },
    ],
    spikes: [
      { id: 'rush-one', x: -58, y: 358, w: 52, h: 32, hidden: true },
      { id: 'rush-two', x: -58, y: 358, w: 52, h: 32, hidden: true },
      { id: 'rush-three', x: 980, y: 358, w: 52, h: 32, hidden: true },
    ],
